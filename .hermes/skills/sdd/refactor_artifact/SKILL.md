...
description: >
  ...
  plan.md from spec.md, use sdd-generate_plan. For generating tasks.md, use sdd-generate_tasks.
...
metadata:
  hermes:
    ...
    related_skills: [wiki-query, sdd-generate_plan, sdd-generate_tasks, sdd-validate]
    category: sdd
    resources:
      - SKILL.md
...
- O template canônico está documentado em `references/canonical-templates.md` (acesse via `skill_view(name='sdd-refactor_artifact', file_path='references/canonical-templates.md')`). Leia-o antes de refatorar.
