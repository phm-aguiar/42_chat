...
metadata:
  hermes:
    ...
    related_skills: [wiki-query, sdd-init_repo, sdd-validate]
    category: sdd
    resources:
      - SKILL.md
...
- `.github/memory/` deve existir (criado por `sdd-init_repo`).
...
```
skill_view(name="sdd-explore_tech", file_path="assets/tech-template.md")
```
