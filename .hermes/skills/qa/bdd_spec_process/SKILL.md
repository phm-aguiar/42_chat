...
metadata:
  hermes:
    ...
    related_skills: [wiki-query, gherkin_scenarios, sdd-brainstorm]
    category: qa
    resources:
      - SKILL.md
---
...
- Consulte a skill `gherkin_scenarios` para anti-patterns
...
- Depois, `sdd-generate_plan` e `sdd-generate_tasks`
- QA usa `gherkin_scenarios` para implementar os .feature files
