...
metadata:
  hermes:
    ...
    related_skills: [wiki-query, go_unit_tests, local_test_runner]
    category: qa
    resources:
      - SKILL.md
...
```
skill_view(name="gherkin_scenarios", file_path="references/syntax.md")
skill_view(name="gherkin_scenarios", file_path="references/best-practices.md")
skill_view(name="gherkin_scenarios", file_path="references/anti-patterns.md")
```
