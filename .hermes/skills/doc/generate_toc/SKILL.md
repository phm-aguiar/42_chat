...
Alternativa com indentação hierárquica (use o script `scripts/generate_toc.sh` — acesse via `skill_view(name='doc-generate_toc', file_path='scripts/generate_toc.sh')`):
...
- [ ] Script `generate_toc.sh` rodou (se usado) sem erros
