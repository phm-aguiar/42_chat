...
description: >
  ...
  as an isolated subagent via delegate_task. Trigger keywords: agent_run, rodar agente,
...
metadata:
  hermes:
    ...
    related_skills: [wiki-query, skill_forge]
    category: agent
    resources:
      - SKILL.md
---
...
- "agent_run", "rodar agente", "executar agente"
