...
Use [[skills/wiki-query|wiki-query]] para buscar metricas do vault, paginas mais referenciadas, ou tendencias de crescimento antes de agir. O vault e a memoria de longo prazo do framework — consultar evita retrabalho e inconsistencias.