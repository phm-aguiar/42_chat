...
sources:
  - "wiki/_raw/SKILL.md"
summary: "Use when designing new high-level system architecture, reviewing existing designs, or making architectural decisions. Invoke to create architecture diagrams, write Architecture Dec..."
provenance:
  extracted: 0.25
  inferred: 0.70
  ambiguous: 0.05
