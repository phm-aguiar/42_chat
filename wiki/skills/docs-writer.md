...
sources:
  - "wiki/_raw/SKILL7.md"
summary: "Write, review, and edit documentation files with consistent structure, tone, and technical accuracy. Use when creating docs, reviewing markdown files, writing READMEs, updating `/d..."
provenance:
  extracted: 0.25
  inferred: 0.70
  ambiguous: 0.05
