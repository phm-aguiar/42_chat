...
sources:
  - "wiki/_raw/SKILL3.md"
summary: "Use when the user asks to make something faster, try many variants, run recursive optimization, benchmark latency/throughput/cost, or choose the best implementation by repeated mea..."
provenance:
  extracted: 0.25
  inferred: 0.70
  ambiguous: 0.05
