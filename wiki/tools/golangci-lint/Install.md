---
title: "Install"
source: "https://golangci.github.io/legacy-v1-doc/welcome/install/"
author:
published:
created: 2026-06-21
...
It's [fast and uses smart caching](https://github.com/golangci/golangci-lint-action#performance) inside, and it can be much faster than the simple binary installation.

![Log output of the action](https://golangci.github.io/legacy-v1-doc/static/816fd283002f2d881be6e251e1fa75e7/efe91/colored-line-number.webp)
...
It can also be installed through [MacPorts](https://www.macports.org/) The MacPorts installation mode is community driven, and not officially maintained by golangci team.
...
[Quick Start: how to use `golangci-lint`](https://golangci.github.io/legacy-v1-doc/welcome/quick-start/).

[Edit this page on GitHub](https://github.com/golangci/golangci-lint/tree/master/docs/src/docs/welcome/install.mdx)