...
tags:
  - cucumber
  - bdd
source: "wiki/_raw/Continuous Integration.md"
created: "2026-06-21"
updated: "2026-06-21"
lifecycle: raw
...
If your CI server is using [Rake](https://cucumber.io/docs/tools/ruby#rake), make sure that Rake executes your Cucumber task.
...
> To get started using Cucumber in [Jenkins](https://jenkins.io/), add a build step running `cucumber -f junit --out WORKSPACE` and then check the 'Publish JUnit test result report', and enter `\*.xml` in the 'Test report XMLs' field. Save and run. (Later improve by using a Rake task and placing your output in a subfolder).
