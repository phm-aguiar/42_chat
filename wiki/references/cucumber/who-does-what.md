...
tags:
  - cucumber
  - bdd
source: "wiki/_raw/Who does what.md"
created: "2026-06-21"
updated: "2026-06-21"
lifecycle: raw
...
These conversations can produce great tests, because each amigo sees the product from a different perspective. For this reason it is *essential* that all of these roles have conversations to discover examples *together*. [Example Mapping](https://cucumber.io/docs/bdd/example-mapping) and Event Storming are great collaborative analysis techniques for discovering examples.
