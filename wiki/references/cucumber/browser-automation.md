...
tags:
  - cucumber
  - bdd
source: "wiki/_raw/Browser automation.md"
created: "2026-06-21"
rag_score: 0.5
updated: "2026-06-21"
lifecycle: raw
...
A detailed tutorial on using Cucumber-JVM with Serenity can be found [here](https://serenity-bdd.info/docs/articles/an-introduction-to-serenity-bdd-with-cucumber.html), and more information on Serenity can be found on their [official website](http://serenity-bdd.info/).
...
Cucumber-Rails is pre-configured with support for view integration testing using [Capybara](https://github.com/jnicklas/capybara) (`script/generate cucumber --capybara`).
...
Taking a screenshot when a scenario fails, might help you to figure out what went wrong. To take a screenshot on failure, you can configure an [`After` hook](https://cucumber.io/docs/cucumber/api#after).
