...
tags:
  - cucumber
  - bdd
source: "wiki/_raw/Example Mapping.md"
created: "2026-06-21"
updated: "2026-06-21"
lifecycle: raw
...
For more details, see Matt Wynne's blog on [Example Mapping](https://cucumber.io/blog/bdd/example-mapping-introduction).

To get started yourself, see Steve Tooke's blog on [Your first Example Mapping session](https://cucumber.io/blog/bdd/your-first-example-mapping-session).

Or have a look at the [Example Mapping Webinar](https://cucumber.io/blog/bdd/example-mapping-webinar).