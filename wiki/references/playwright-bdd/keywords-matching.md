...
tags:
  ...
  - configuration
created: 2026-06-21
source: "https://vitalets.github.io/playwright-bdd/#/writing-steps/keywords-matching"
---
...
In some cases, you may want to restrict such behavior and require keywords matching in addition to the step pattern. Since **Playwright-BDD v8**, you can enable that with the [`matchKeywords`](#/configuration/options?id=matchkeywords) option:
