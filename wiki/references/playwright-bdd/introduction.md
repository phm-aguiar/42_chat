---
title: "Playwright-BDD documentation"
tags:
  - playwright-bdd
  - overview
  - introduction
created: 2026-06-21
source: "https://vitalets.github.io/playwright-bdd/#/"
---
...
Jump to the [getting started](#/getting-started/index) guide or read below the overview of Playwright-BDD project.
...
The second command `npx playwright test` runs the generated files with the Playwright runner. Step definitions have access to the Playwright APIs and fixtures (e.g. `page`):
...
![Playwright html report](https://vitalets.github.io/playwright-bdd/reporters/_media/pw-html-report.png)

Proceed to the [installation guide](#/getting-started/installation) and try it yourself.
