---
title: "Write first BDD test"
tags:
  - playwright-bdd
  - getting-started
  - tutorial
created: 2026-06-21
source: "https://vitalets.github.io/playwright-bdd/#/getting-started/write-first-test"
---
...
> There are alternative ways of defining steps: [Decorators](#/writing-steps/decorators) and [Cucumber-style syntax](#/writing-steps/cucumber-style).
...
![Playwright HTML report](https://vitalets.github.io/playwright-bdd/getting-started/_media/playwright-report.png)

### Step 5: Check the generated tests (optional)

Check out the `.features-gen` directory to see what the generated tests look like. You will see something like this:
...
> Don't forget to [git-ignore generated files](#/guides/ignore-generated-files).

If your project uses [ES Modules](https://nodejs.org/api/esm.html), please check out [ESM configuration](#/configuration/esm).
