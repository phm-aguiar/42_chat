...
> You can use the [Tags from path](#/writing-features/tags-from-path) approach to automatically bind step definitions to features without adding explicit tags.
