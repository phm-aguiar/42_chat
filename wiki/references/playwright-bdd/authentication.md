...
It is important to set an explicit `testDir` for the setup project so Playwright knows where to look for its test files (see [Projects](#/configuration/multiple-projects)):
