...
- Não executa tasks — isso é o [[agent-orchestrator]]

## Relacionado

- [[agent-orchestrator]] — Executor runtime (complementar)
- [[sdd]] — Metodologia
- [[feature-005-agent-orchestrator|005: Agent Orchestrator]] — Feature que implementa o executor
