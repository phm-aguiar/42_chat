...
- **Feature Fonte:** `specs/features/010-sdd-templates/spec.md`
...
- **Fonte da Verdade:** `spec-elementos-sdd.md` (agora em `010-sdd-templates/spec.md`) é o documento raiz. Alterações aqui propagam para `sdd-refactor-artifact/references/canonical-templates.md`.
