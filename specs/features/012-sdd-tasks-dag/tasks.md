...
- [x] **T007:** Testar geração de DAG com spec real (feature 005 como cobaia): verificar ausência de ciclos, paralelismo correto, isolamento de arquivos
  ...
  - **Paralelizável:** false
  - **Arquivos:** `specs/features/013-runtime-orchestrator/tasks.md`
