...
- [x] **T011:** Testar happy path: usar tasks.md da feature 004 como cobaia, verificar execução completa com `[x]` em todas as tasks
  ...
  - **Paralelizável:** false
  - **Arquivos:** `specs/features/012-sdd-tasks-dag/tasks.md`

- [x] **T012:** Testar approval gate: invocar orchestrator com `Aprovado: false` → deve abortar
  - **Papel:** QA
  - **Dependências:** T011
  - **Paralelizável:** true
  - **Arquivos:** `specs/features/013-runtime-orchestrator/test-fixtures/spec-not-approved.md`

- [x] **T013:** Testar retry com falha: criar task que falha 2x e passa na 3ª → verificar contexto enriquecido
  - **Papel:** QA
  - **Dependências:** T011
  - **Paralelizável:** true
  - **Arquivos:** `specs/features/013-runtime-orchestrator/test-fixtures/failing-task/`

- [x] **T014:** Testar escalação: task falha 3x → orchestrator deve pausar sub-árvore e pedir input humano
  - **Papel:** QA
  - **Dependências:** T013
  - **Paralelizável:** false
  - **Arquivos:** `specs/features/013-runtime-orchestrator/test-fixtures/hard-fail-task/`
